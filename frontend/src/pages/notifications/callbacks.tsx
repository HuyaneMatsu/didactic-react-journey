...
export function create_change_notification_option_callback(page_loader_api: PageLoaderAPI, system_name: string) {
    return (event) => change_notification_option(page_loader_api, system_name, event);
}

function change_notification_option(page_loader_api: PageLoaderAPI, system_name: string, event: ChangeEvent) {
...
async function save_notification_settings(page_loader_api: PageLoaderAPI, handler: RequestLifeCycleHandler) {
    try {
...
export function create_revert_changes_callback(page_loader_api: PageLoaderAPI) {
